                ...
                <div className="Register">
                    ...
                    <form className="Register-form" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <select
                            {...register("role")}
                            >
                            <option value="teacher" onChange={handleSelectTeacher}>nauczyciel</option>
                            <option value="parent" onChange={handleSelectParent}>rodzic</option>
                            <option value="pupil" onChange={handleSelectPupil}>dziecko</option>
                        </select >
                        <text>Imię</text>
                        <input
                            {...register("name")}
